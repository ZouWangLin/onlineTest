			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">试题题库</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<div class="table-responsive">
												...
												<c:forEach items="${requestScope.page.rows}" var="subject"
													...
													<tr>
														...
														<a class="btn btn-primary"
															...
															data-toggle="modal" data-target="#viewTest">查看试题</a>
														<a class="btn btn-success"
															onclick="viewTest(${subject.subjectid})" role="button"
															data-toggle="modal" data-target="#updateTest">更新试题</a> 
														<a class="btn btn-primary" onclick="deleteTest(${subject.subjectid})"
															 role="button">删除试题</a></td>
													</tr>
												</c:forEach>
											</c:when>
											<c:otherwise>
												<td colspan="9">当前题库没有试题了，通知管理员添加题目！</td>
											</c:otherwise>
										</c:choose>
									</tbody>
								</table>
								<div class="col-md-12 text-right">
									<itcast:page
										url="${pageContext.request.contextPath }/managerTest/showTest" />
								</div>
							</div>
						</div>
						<!-- /.panel-body -->
							...
							<div class="col-md-12">
								<form role="form" class="form-horizontal" id="updateTestForm">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<input class="form-control subjectoptiona" name="subjectoptiona">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-2">答案B</label>
										<div class="col-md-10">
											<input class="form-control subjectoptionb" name="subjectoptionb">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-2">答案C</label>
										<div class="col-md-10">
											<input class="form-control subjectoptionc" name="subjectoptionc">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-2">答案D</label>
										<div class="col-md-10">
											<input class="form-control subjectoptiond" name="subjectoptiond">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<textarea class="form-control subjectparse" rows="3" name="subjectparse"></textarea>
										</div>
									</div>
								</form>
							</div>
			...
			<div class="modal-footer">
				<div class="row">
					<div class="col-md-4 col-md-offset-4">
						...
						<button type="button" class="btn btn-default" onclick="updateTestSubmit()">提交更改</button>
					</div>
				</div>
			</div>
		</div>
